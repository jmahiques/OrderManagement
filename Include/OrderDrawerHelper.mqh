...
{
   string name = getObjectName(order.getTicket(), partialStopLossName);
...
{
   string name = getObjectName(order.getTicket(), partialTakeProfitName);
...
{
   string name = getObjectName(order.getTicket(), partialStopLossToBreakEvenName);
...
{
   string name = getObjectName(order.getTicket(), stopLossToBreakEvenName);
