...
public:
   ...
   virtual int sell(string symbol, double lots, double sl, double tp, string comment, color arrowColor = clrRed);
...
int OrderExecutionHelper::sell(string symbol, double _lots, double sl, double tp, string _comment, color arrowColor = clrRed)
{
